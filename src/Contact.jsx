            ...
            <div className="text-white mt-10 pt-10 mb-12" >
                ...
                <div className="ml-0 px-5 md:px-0 md:ml-20">
                    ...
                    <p className="flex flex-row gap-4 mt-4">
                        <a href="https://www.instagram.com/_armaan8_/" target="_blank"><img src={instagram} className="bg-white h-10 md:h-10 rounded-lg " /></a>
                        <a href="https://www.linkedin.com/in/armaanit-singh-515b862b9/" target="_blank"><img src={linkedin} className="bg-white h-10 md:h-10 rounded-lg " /></a>
                        <a href="mailto:armaanitsingh6@gmail.com" target="_blank"><img src={email} className="bg-white h-10 md:h-10 rounded-lg " /></a>
